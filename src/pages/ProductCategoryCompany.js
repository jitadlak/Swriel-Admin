                    ...
                    <Scrollbar>
                        <Modal open={open2} onClose={onCloseModal}  >
                            <Stack spacing={4}>
                                ...
                                <TextField name="ProductName" label="Product Name" onChange={(event) => setProductCategory(event.target.value)} />
                                <TextField name="Product Price" label="Product Price" onChange={(event) => setProductCategory(event.target.value)} />
                                <TextField name="Product Title" label="Product Title" onChange={(event) => setProductCategory(event.target.value)} />
                                <TextField name="Product Description" label="Product Description" onChange={(event) => setProductCategory(event.target.value)} />
                                <TextField name="Product Company" label="Product Company" onChange={(event) => setProductCategory(event.target.value)} />
