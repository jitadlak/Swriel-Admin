                    ...
                    <Scrollbar>
                        <Modal open={open2} onClose={onCloseModal} center>
                            <Stack spacing={3}>
                                ...
                                <TextField name="percenoff" label="Percentage Off" onChange={(event) => setPercentOff(event.target.value)} />
                                            ...
                                            <TableRow hover key={_id} tabIndex={-1} role="checkbox" selected={selectedUser}>
                                                ...
                                                <TableCell component="th" scope="row" padding="none">
                                                    <Stack direction="row" alignItems="center" spacing={2}>
                                                        <img src={`http://localhost:8000/${promoImg}`} alt={promoname} style={{ height: 80, width: 80, alignSelf: 'center', margin: 10 }} />
                                                    </Stack>
                                                </TableCell>
